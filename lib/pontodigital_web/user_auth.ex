defmodule PontodigitalWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      PontodigitalWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      PontodigitalWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule PontodigitalWeb.PageLive do
        use PontodigitalWeb, :live_view

        on_mount {PontodigitalWeb.UserAuth, :mount_current_scope}
        ...
      end
