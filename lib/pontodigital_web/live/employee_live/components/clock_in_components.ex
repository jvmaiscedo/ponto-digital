defmodule PontodigitalWeb.EmployeeLive.Components.ClockInComponents do
  ...
  @doc """
  Grid de botões para registro de ponto.
  Dispara o evento "registrar_ponto" para a LiveView pai.
  """
  def clock_in_grid(assigns) do
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
      ...
      <.action_button
        ...
        description="Fim do dia de trabalho"
  ...
  # Definição de cores (Estilo Admin/Tailwind)
